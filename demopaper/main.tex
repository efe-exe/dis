...
email address or ORCID}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Efe Enes Nayci}
\IEEEauthorblockA{\textit{Department of Informatics} \\
\textit{Universit\"at Hamburg}\\
Hamburg, Germany \\
...
method)~\cite{holt2004,winters1960} with a seasonality period of $m=7$ days, reflecting
the pronounced weekly pattern in the data, extended by a damped trend~\cite{gardner1985}.
