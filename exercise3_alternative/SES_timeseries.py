...
def main() -> None:
    ...
    parser.add_argument("-a",
                        ...
                        help="""Level smoothing factor in [0, 1] """
                             """(Single Exponential Smoothing). Default: 0.3""")
    ...
    forecast_series = SES_forecaster.forecast(
        history, forecast_from, forecast_until, alpha=args.alpha)
    ...
    plt.title(
        ...
        f"(Single Exponential Smoothing: \u03b1={args.alpha})")
    plt.legend()
