...
def main() -> None:
    ...
    parser.add_argument("-a",
                        ...
                        help="""Level smoothing factor in [0, 1] """
                             """(Double Exponential Smoothing). Default: 0.3""")
    parser.add_argument("-b",
                        "--beta",
                        type=float,
                        default=0.05,
                        help="""Trend smoothing factor in [0, 1] """
                             """(Double Exponential Smoothing). Default: 0.05""")
    ...
    forecast_series = DES_forecaster.forecast(
    ...
    plt.title(
        ...
        f"(Double Exponential Smoothing: \u03b1={args.alpha}, \u03b2={args.beta})")
    plt.legend()
